  ...
  return (
    <div style={{ backgroundColor: '#0D1117', color: '#E6EDF3', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Inter, sans-serif' }}>
      ...
      <motion.div
        ...
        <p style={{ color: '#8B949E', textAlign: 'center', marginBottom: '32px' }}>Create your account and start logging!</p>

        {/* Name */}
        <div style={{ marginBottom: '16px' }}>
          <label style={{ display: 'block', marginBottom: '6px', fontSize: '14px', color: '#8B949E' }}>Full Name</label>
          <input
            type="text"
            name="name"
            value={form.name}
